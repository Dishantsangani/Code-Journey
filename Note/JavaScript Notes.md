...
1. Filter
   ...
   Filter is return New array when passed in test
...
1. Some
   the some() method is used to check if at least one element in an array meets a specified condition. It returns true if any element passes the test, and false if none do.
...
9. Ternory
   A ternary operator is a conditional operator in programming that takes three operands and evaluates an expression based on a condition.

10. this (Keyword)
    This Keyworc Represent Current Context.
